...
Get-NetIPAddress
# My interface index was #4, get an IP address from the lecturer, the range is 172.28.78.1-50
New-NetIPAddress -InterfaceIndex 4 -IPAddress 172.28.78.16 -PrefixLength 22 -DefaultGateway 172.28.76.20
# Set DC-1 as being the DNS
Set-DnsClientServerAddress -InterfaceIndex 4 -ServerAddresses 172.28.78.15
